<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportFinl1.aspx.cs" Inherits="ReportFinl1" MasterPageFile="~/MainFile.master" %>
                    ...
                    <div class="widget-content">
                        <ul class="menu vertical">                            
                           <%-- <li class="active"><a href="Dashboard.aspx">My Dashboard</a></li>--%>
                            <li class="active"><a href="ReportFinl.aspx?Myid=1">Family Details</a></li>
                       ...
                       <%-- <div class="well">--%>
                            <div class="row">                      
                                ...
                                <div class="medium-2 small-12 columns">
                                 ...
                                 <div class="medium-2 small-12 columns" style="float:right">
                                   <input type="button" onclick="tableToExcel('example', 'W3C Example Table')" class="button primar margin-bottom-10" style="background-color:#02646f; margin:5px 5px 0px 0px;color:white; border-radius:10px; font-size:20px; width:140px" value="Export" style="margin-top:-35px;"/>                               
                        ...
                        <div class="medium-12 small-12 columns" id="idColumn">
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr style="color:whitesmoke; background-color:#02646f">
                                       <%-- <th>ID</th>--%>
                                        <th>Name</th>
                                        <th>Relation</th>
                                        <th>DOB</th>
