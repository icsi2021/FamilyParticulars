...
public partial class UploadAttachment : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        using (SqlConnection con = new SqlConnection(constr))
        {
            ...
            {
                cmd.CommandText = "Select EMPCODE, FILENAME,Data,MEMBERNAME,ContentType from ATTACHMENT where EMPCODE='" + ViewState["EMPCODE"].ToString() + "'";
                cmd.Connection = con;
                con.Open();
                    ...
                    using (Stream fs = FileUpload.PostedFile.InputStream)
                    {
                        using (BinaryReader br = new BinaryReader(fs))
                        {
                            ...
                            using (SqlConnection con = new SqlConnection(constr))
                            {
                                ...
                                {
                                    cmd.Connection = con;
                                    cmd.Parameters.AddWithValue("@Empcode", ViewState["EMPCODE"].ToString());
