<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportFinlAdmin1.aspx.cs" Inherits="ReportFinlAdmin1" MasterPageFile="~/MainFile.master" %>
                    ...
                    <div class="medium-10 small-12 columns margin-top">
                        <div class="block-info">
                            <div class="inner-title margin-bottom-20">
                                <h4>
                                    <asp:Label ID="lbltname" runat="server" Text=""></asp:Label></h4>
